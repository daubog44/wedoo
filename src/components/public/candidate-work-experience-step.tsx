...
export function CandidateWorkExperienceStep({
  ...
  return (
    ...
    >
      <div className="rounded-[20px] border border-[var(--wedoo-workspace-line)] bg-[var(--wedoo-workspace-surface)] px-5 py-5 md:px-[26px] md:py-6">
        <form
        ...
        >
              ...
              <section className="space-y-2">
                <div className="grid gap-2 md:grid-cols-[auto_1fr] md:items-baseline md:gap-4">
                  ...
                  />
                  <p className="font-wedoo-body text-[0.95rem] leading-[1.2] text-[var(--wedoo-ink-muted)] md:justify-self-end">
              ...
              <section className="space-y-4">
                <h2 className="font-wedoo-accent text-[1.5rem] leading-none text-[var(--wedoo-ink)] md:text-[1.75rem]">
                  attività svolte
                </h2>
