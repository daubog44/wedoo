...
function PreferenceSection({
  ...
  return (
    <section className="space-y-3.5">
      <h2 className="font-wedoo-accent text-[1.5rem] font-normal leading-none text-[var(--wedoo-ink)] md:text-[1.875rem]">
        {label}
      </h2>
...
export function CandidateWorkPreferencesStep({
  ...
  return (
    ...
    >
      <div className="rounded-[20px] border border-[var(--wedoo-workspace-line)] bg-[var(--wedoo-workspace-surface)] px-5 py-5 md:px-[29px] md:py-[27px]">
        <form
