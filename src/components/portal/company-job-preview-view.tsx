...
function CompanyJobPreviewRichTextBox({
  body,
  className,
  minHeightClassName,
  toolbarLabel,
          ...
          <div className="flex justify-end pt-14">
            <div className="flex flex-col items-end gap-7">
              <div className="flex items-center gap-6">
                ...
                <button
                  className={cn(primaryButtonClassName, "min-w-[160px]")}
                  onClick={onSubmit}
                  type="button"
                >
      ...
      <div className="relative">
        ...
        <div className="flex flex-col items-end gap-4 pt-6">
          <div className="flex w-full items-center justify-end gap-4">
            ...
            <button
              className={cn(primaryButtonClassName, "min-w-[140px]")}
              onClick={onSubmit}
              type="button"
            >
              {detail.ctas.primaryLabel}
