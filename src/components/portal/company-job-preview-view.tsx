...
function CompanyJobPreviewCtaTray({
  detail,
  onCancel,
  onSaveDraft,
  onSubmit,
    ...
    <PortalDetailCard tone={tone}>
      <div className="flex items-center gap-4">
        ...
        <p className="font-wedoo-body text-sm leading-6 text-slate-500">
          Preview recruiter stabilizzata: invio in evidenza, draft e annulla come
          azioni secondarie.
        </p>
      </div>
...
function CompanyJobPreviewMobileDock({ label }: { label: string }) {
  const toneClasses = getPortalDetailToneClasses(tone);
...
function CompanyJobPreviewDesktopShell({
  detail,
  onCancel,
  onClose,
  onSaveDraft,
  ...
  return (
    <section
      ...
      data-company-job-preview-layout="desktop"
    >
      <PortalDetailCanvas tone={tone}>
        <div className="flex justify-end">
          <button
            aria-label="Chiudi anteprima annuncio"
        ...
        <div className="mt-6 grid gap-6 xl:grid-cols-[minmax(0,1.18fr)_360px]">
          <div className="space-y-6">
            <PortalDetailCard tone={tone}>
              ...
              <PortalDetailToolbarCard
                body={detail.sections.companyBody || "Canvas recruiter riallineato per dare piu struttura al brand, alle certificazioni e ai contenuti di contesto."}
                className="mt-5"
...
function CompanyJobPreviewMobileShell({
  detail,
  onCancel,
  onClose,
  onSaveDraft,
  ...
  return (
    <section
      ...
      data-company-job-preview-layout="mobile"
    >
      <PortalDetailCanvas tone={tone} className="px-4 py-4">
        ...
        <div className="mt-4 space-y-4">
          ...
          <PortalDetailCard tone={tone}>
            ...
            <PortalDetailToolbarCard
              body={detail.sections.companyBody || "Questa anteprima recruiter usa lo stesso canvas del dettaglio candidato ma con CTA e densita piu adatte al lato azienda."}
              className="mt-4"
        ...
        <CompanyJobPreviewMobileDock label={detail.mobileDockLabel} />
      </PortalDetailCanvas>
    </section>
  );
}
