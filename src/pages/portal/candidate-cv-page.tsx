  ...
  return (
    <main className="px-4 pb-12 pt-8 md:px-8">
      <div className="mx-auto max-w-5xl">
        <h2 className="mb-4 text-center text-3xl">anteprima del mio cv:</h2>
        <DetailCard tone="mint">
          ...
          <DetailSection title={<b>Descrizione personale</b>} tone="mint">
            <p>{candidate.bio}</p>
          </DetailSection>
          <div className="grid gap-6 md:grid-cols-2">
            <DetailSection title={<b>Info</b>} tone="mint">
              <DetailBulletList items={[candidate.city, candidate.email, candidate.phone]} />
            </DetailSection>
            <DetailSection title={<b>Formazione</b>} tone="mint">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-3 md:justify-end">
            ...
            <DetailActionLink tone="mint">pubblica</DetailActionLink>
          </div>
        </DetailCard>
      </div>
    </main>
