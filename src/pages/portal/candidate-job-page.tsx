      ...
      <div className="mx-auto max-w-5xl">
        <DetailCard tone="mint">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-3">
            <DetailActionLink tone="mint" variant="outline">
          ...
          <DetailSection title={<b>Riassunto offerta</b>} tone="mint">
            <DetailBulletList items={job.summary} />
          </DetailSection>
          <div className="grid gap-6 md:grid-cols-2">
            <DetailSection title={<>Competenze richieste: <b>Hard skills</b></>} tone="mint">
              <DetailBulletList items={job.hardSkills} />
            </DetailSection>
            <DetailSection title={<>Competenze richieste: <b>Soft skills</b></>} tone="mint">
              <DetailBulletList items={job.softSkills} />
            </DetailSection>
          </div>
          <DetailSection title={<b>Job description</b>} tone="mint">
            <p>{job.description}</p>
          </DetailSection>
          <DetailSection title={<b>Dettagli azienda</b>} tone="mint">
          ...
          <DetailSection title={<b>{job.requirements}</b>} tone="mint">
            <div className="flex justify-center md:justify-end">
              <DetailActionLink tone="mint">candidati</DetailActionLink>
            </div>
          </DetailSection>
        </DetailCard>
      </div>
