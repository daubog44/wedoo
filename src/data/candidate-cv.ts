...
export function createCandidateCvResponse(
  candidateProfile: CandidateProfileDraft = candidateProfileDraftMock,
) {
  return {
    ...
    sections: {
      ...
      personalDataItems: [
        `${formatCandidateContactLocation(candidateProfile.contact)};`,
        `${candidateProfile.contact.email};`,
        candidateProfile.contact.phone,
      ],
      personalDataTitle: "dati personali",
      workPreferenceItems: formatCandidateWorkPreferenceItemsForCv(
        candidateProfile.workPreferences,
      ),
...
export const candidateCvResponseMock = createCandidateCvResponse();
