...
- [x] [TECH][node=n/a][route=*][test=tests/e2e/public/landing-page.spec.ts] Eseguire il batch `wedoo-cross-route-modernization-pass` per ridurre la densita testuale, ripulire le primitive condivise e riallineare il tono visivo tra pubblico e portale, con prove iniziali nel route map `src/router.tsx`, nelle shell editoriali `src/components/public/knowledge-hub-page.tsx` e `src/components/public/info-sections.tsx` e nei dashboard `src/pages/portal/candidate-dashboard-page.tsx` `src/pages/portal/company-dashboard-page.tsx`.
- [x] [FRAME][node=no dedicated node][route=/info,/articoli,/podcast,/][test=tests/e2e/public/knowledge-hub-page.spec.ts] Modernizzare la famiglia editoriale pubblica mantenendo il tono Wedoo ma tagliando i blocchi descrittivi troppo lunghi, ripulendo CTA e card e rendendo piu coerenti hero, note e cross-link, con evidenza in `src/components/public/knowledge-hub-page.tsx`, `src/components/public/info-sections.tsx` e `src/components/public/home/home-sections.tsx`.
- [x] [FRAME][node=159:2896][route=/portale/candidato,/portale/azienda][test=tests/e2e/portal/candidate-dashboard-page.spec.ts] Modernizzare dashboard, rail profilo, card e navbar del portale come unico sistema UI, riducendo la verbosita dei pannelli hero e l'effetto collage delle card, con evidenza in `src/pages/portal/candidate-dashboard-page.tsx`, `src/pages/portal/company-dashboard-page.tsx`, `src/components/site/portal-navbar.tsx` e card/rail correlate.

- [x] [FRAME][node=288:1266,288:1325][route=/portale/candidato/cv][test=tests/e2e/parity/candidate-cv-page.visual.spec.ts] Modernizzare il profilo CV candidato come parte del batch `portal detail`, sostituendo il canvas ancora rigido e scalato male con una shell editoriale coerente con il frame Figma e con i nuovi dashboard portale, come provato da `artifacts/loop-captures/2026-04-18/0146-final-candidate-cv-sweep`.
- [x] [FRAME][node=172:1273,178:1640][route=/portale/candidato/annuncio/:jobId][test=tests/e2e/parity/candidate-job-page.visual.spec.ts] Modernizzare il detail annuncio candidato nel batch `portal detail`, correggendo la pagina ancora troppo vuota, stretta e legacy rispetto al frame lavanda Figma, come provato da `artifacts/loop-captures/2026-04-18/0146-final-candidate-job-sweep`.
- [x] [FRAME][node=181:608,184:795][route=/portale/azienda/candidati/:candidateId][test=tests/e2e/parity/company-candidate-page.visual.spec.ts] Modernizzare il detail candidato azienda nel batch `portal detail`, riallineando header, pannelli contenuto e CTA recruiter al frame menta Figma invece della versione ancora proto-legacy, come provato da `artifacts/loop-captures/2026-04-18/0146-final-company-candidate-sweep`.
- [x] [FRAME][node=172:1273,178:1640][route=/portale/azienda/annunci/:jobId][test=tests/e2e/parity/company-job-page.visual.spec.ts] Modernizzare la preview annuncio azienda nel batch `portal detail`, riallineando la shell lavanda e le CTA recruiter al frame `Annuncio di Lavoro` invece del layout ancora troppo scarno e disallineato, come provato da `artifacts/loop-captures/2026-04-18/0146-final-company-job-sweep`.

- [x] [FRAME][node=no dedicated node][route=/info][test=tests/e2e/parity/info-page.visual.spec.ts] Modernizzare la route pubblica `/info` come parte del batch editoriale pubblico, mantenendo il linguaggio Wedoo ma alleggerendo la composizione ancora troppo rigida e pesante su mobile, con capture reali `artifacts/loop-captures/2026-04-18/0132-batch-info-before` come prova e parity aggiornata sul target corretto.
- [x] [FRAME][node=no dedicated node][route=/candidato][test=tests/e2e/parity/candidate-showcase-page.visual.spec.ts] Modernizzare la showcase candidato come parte del batch pubblico, correggendo la shell ancora troppo vuota e datata, l'assenza di un ecosistema di supporto attorno allo slide attivo e la composizione debole di desktop/mobile, con prove in `artifacts/loop-captures/2026-04-18/0132-batch-candidate-showcase-before`.
- [x] [FRAME][node=no dedicated node][route=/azienda][test=tests/e2e/parity/company-showcase-page.visual.spec.ts] Modernizzare la showcase azienda in lockstep con la shell condivisa delle showcase pubbliche, correggendo la resa ancora troppo sparsa e poco editoriale e mantenendo CTA e flow coerenti, con prove in `artifacts/loop-captures/2026-04-18/0132-batch-company-showcase-before`.
- [x] [FRAME][node=143:1822][route=/][test=tests/e2e/parity/landing-page.visual.spec.ts] Modernizzare di nuovo la homepage pubblica contro il frame Figma `143:1822`, mantenendo il linguaggio Wedoo ma correggendo la composizione ancora troppo piatta e legacy della hero, delle feature card e della sezione video, con capture reali `artifacts/loop-captures/2026-04-18/0042-route-home-sweep` come prova e parity aggiornata solo dopo riallineamento intenzionale.
- [x] [FRAME][node=658:667,657:658,660:725,336:593][route=/accedi,/password-dimenticata,/assistenza-clienti,/registrati][test=tests/e2e/parity/login-page.visual.spec.ts] Modernizzare la famiglia di shell pubbliche auth/support/register mantenendo il linguaggio Wedoo ma rimuovendo footer legacy, pulsanti incoerenti e composizioni troppo rigide, usando i frame Figma esistenti come base e design inference coerente dove il design vivo non basta piu.
- [x] [FRAME][node=273:1313,337:701][route=/registrati/candidato/1,/registrati/azienda/1][test=tests/e2e/public/public-routes.spec.ts] Modernizzare gli step pubblici account candidato e azienda mantenendo copy e flow ma sostituendo le shell di onboarding legacy con una grammatica coerente con il nuovo sistema pubblico, riallineando CTA, card, chip lingua e gerarchia hero tra candidato e azienda.
- [x] [TECH][node=n/a][route=n/a][test=tests/integration/*.test.ts] Stabilizzare `npm run test:integration` su Windows/Codex worktree eliminando i timeout del pool Vitest che oggi fanno fallire `npm run test:all` pur con test verdi, cosi il gate complessivo torna affidabile.
- [x] [FRAME][node=172:1273][route=/portale/candidato/annuncio/:jobId][test=tests/e2e/portal/candidate-job-page.spec.ts] Riaprire e riallineare il detail annuncio candidato contro i frame Figma desktop `172:1273` e mobile `178:1640`, correggendo il desktop che nel browser reale resta troppo compresso e sbilanciato a sinistra rispetto al canvas lavanda e alla gerarchia header del frame.
- [x] [FRAME][node=288:1266][route=/portale/candidato/cv][test=tests/e2e/portal/candidate-cv-page.spec.ts] Riaprire e riallineare la preview CV candidato contro i frame Figma desktop `288:1266` e mobile `288:1325`, correggendo la strip superiore e il pannello destro che nel browser reale si clippano di nuovo fuori canvas sul desktop.
- [x] [FRAME][node=259:1050][route=/portale/azienda/annunci/nuovo?step=2][test=tests/e2e/portal/company-job-draft-step-2.spec.ts] Riaprire e riallineare il secondo step `crea il tuo annuncio` contro i frame Figma desktop `259:1050` e mobile `259:1162`, correggendo il mobile che mostra ancora hero media e note desktop assenti nel frame reale e rendendo il desktop piu stabile fuori dal viewport perfetto 1440 senza wrap del titolo o compressione del pannello.
- [x] [FRAME][node=258:847][route=/portale/azienda/annunci/nuovo][test=tests/e2e/portal/company-job-draft-step-1.spec.ts] Riaprire e riallineare il primo step `crea il tuo annuncio` contro i frame Figma desktop `258:847` e mobile `258:956`, correggendo il testo descrittivo che oggi tracima nel pannello hero desktop e la shell mobile ancora troppo compressa rispetto al canvas reale.
